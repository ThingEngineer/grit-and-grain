...
| ----- | ------------------------------------------------ | ----------------------------------------------------------------------------------------- | ----------- | --------- |
| **B** | [phase-b-database.md](phase-b-database.md)       | Supabase migration: tables, RLS, indexes, triggers, pgvector, functions                   | Not started | 1–2 hrs   |
| **C** | [phase-c-crud-ux.md](phase-c-crud-ux.md)         | Dashboard, diary entry form/list, pasture/herd management, app layout                     | Not started | 2–3 hrs   |
| **D** | [phase-d-seed-data.md](phase-d-seed-data.md)     | Seed API route: "Dry Creek Ranch" demo data (pastures, herds, 12 months of diary entries) | Not started | 1–2 hrs   |
